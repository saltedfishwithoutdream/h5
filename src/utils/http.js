...
export class AxiosWrapper {
  ...
  constructor ({ name, loading_name, responseType = 'json', headers = {}, dispatch, commit, router, successMsg, failMsg, successCallback, failCallback, customRequest, actionPayloadExtra = {} }) {
    ...
    'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NvdW50IjoxMDYwMDE0LCJleHAiOjE2NjY1MjYzNzUsImlhdCI6MTY2NTY2MjM3NSwiaXNzIjoiaHR0cHM6Ly93d3cuc2h1aW5mby5jb20iLCJwb3MtYWNjb3VudCI6MTA2MDAxNCwicG9zLWRldmljZSI6IiIsInBvcy1zdG9yZSI6IiIsInRlbmFudCI6NDAwMDN9.UUX6H93dEPaaogyTeTX06iqIxwrf-YXDSfieRmLGvcA'
    this.instance = axios.create({
      baseURL: 'https://digiprime-test.shuinfo.com/api/v2',
      responseType,
